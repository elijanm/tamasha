...
export function UsersPage() {
  ...
  return (
    <div className="space-y-5 animate-fadeIn">
      ...
      {!isLoading && allUsers.length > 0 && <StatsBar users={allUsers} />}
        ...
        <CardHeader className="pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            <div>
              ...
              <CardDescription>{data ? `${filtered.length} of ${data.total} users` : "Loading…"}</CardDescription>
            </div>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="py-12 text-center">
              <p className="text-sm font-body text-stone-500">No users match your filters</p>
            </div>
          ) : (
