...
import {
  ...
  Library, Scissors, Play, Pause, Settings, Radio, Users,
} from "lucide-react";
    ...
    <aside className="flex flex-col h-full w-64 bg-stone-950 border-r border-stone-800/60">
      ...
      <div className="px-5 py-5 border-b border-stone-800/60">
        <div className="flex items-center gap-2.5">
          {theme === "simple" ? (
            <img src="/tamasha-logo.png" alt="Tamasha" className="w-8 h-8 flex-shrink-0" />
          ) : (
            <img src="/favicon.svg" alt="Tamasha" className="w-7 h-7 flex-shrink-0"
              style={{ filter: "drop-shadow(0 0 6px rgba(134,59,255,0.5))" }} />
          )}
          <span className="font-display font-bold text-lg text-stone-100 tracking-tight">
            Tamasha
          </span>
        </div>
        {roleMeta && (
