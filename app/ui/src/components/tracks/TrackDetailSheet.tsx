        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
          ...
          <div>
            ...
            <div className="bg-stone-900/60 rounded-lg px-3">
              ...
              <div className="flex items-start gap-3 py-2">
                <span className="text-xs font-mono text-stone-600 w-28 flex-shrink-0 pt-1">Source Folder</span>
                <span className="text-[10px] font-mono text-stone-600 flex-1 break-all pt-1">
                  {track.r2_key_raw.includes("/")
                    ? track.r2_key_raw.substring(0, track.r2_key_raw.lastIndexOf("/"))
                    : track.r2_key_raw}
                </span>
              </div>
            </div>
