...
export function PlayerBar() {
  ...
  useEffect(() => {
    ...
    tracksApi
      ...
      .catch((err: unknown) => {
        setIsPlaying(false);
        // Track no longer exists — clear the player entirely
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-stone-950/95 backdrop-blur-md border-t border-stone-800 px-4 py-3">
      <div className="max-w-screen-2xl mx-auto flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 w-56 flex-shrink-0 min-w-0">
          <div className="w-9 h-9 rounded-md bg-stone-800 flex items-center justify-center flex-shrink-0 overflow-hidden">
            {track.artwork_url
